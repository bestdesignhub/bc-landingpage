            ...
            <div className="form-container">
              <div className="bg-white bg-transparent rounded-lg p-4 mt-10 signupform">
                <h2 className="main-title">
                  <span>Sign up and Win </span>prizes worth <strong>€4.000</strong>
                </h2>
                <p className="subtext text-sm text-black text-center mb-3">
                  You're now officially part of our exciting competition, giving you the chance to win exclusive cashmere sweaters worth <strong>€4,000</strong> over the next two months!  For every <strong>200 sign-ups</strong>, we will draw one lucky winner who will receive a custom-designed cashmere sweater, tailored for either men or women.
                </p>
